...
void main() {
  ...
  test('标准持久化 Repository 的公有 CRUD 与物理 Key 定位由生成 Mixin 提供', () {
    ...
    expect(repositories, hasLength(120));
    ...
    expect(generatedDestroyCount, 120);
    expect(generatedGetCount, 120);
    expect(generatedStoreCount, 120);
    expect(generatedUpdateCount, 120);
  });
