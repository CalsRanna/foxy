...
part of 'item_set_list_view_model.dart';

mixin _ItemSetListViewModelMixin on FieldControllerMixin, QueryVersionMixin {
  final _repository = GetIt.instance.get<ItemSetRepository>();

  final items = signal(<BriefItemSetEntity>[]);
  ...
  Future<void> _refresh() async {
    ...
    try {
      final (nextItems, nextTotal) = await (
        _repository.getBriefItemSets(page: currentPage, filter: filter),
