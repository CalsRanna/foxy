...
@FoxyDetailViewModel(entity: CreatureLootTemplateEntity, flags: {'lootMode'})
class CreatureLootTemplateCollectionEditorViewModel
    with
        FieldControllerMixin, _CreatureLootTemplateCollectionEditorViewModelMixin {
  final _repository = GetIt.instance.get<CreatureLootTemplateRepository>();

  final parentKey = signal<int?>(null);
  final items = signal<List<BriefCreatureLootTemplateEntity>>([]);
