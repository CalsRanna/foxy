...
part of 'glyph_property_list_view_model.dart';

mixin _GlyphPropertyListViewModelMixin
  ...
  GlyphPropertyFilter _collectFilter() {
    return GlyphPropertyFilter(id: idController.collect());
  }
  ...
  Future<void> _refresh() async {
    ...
    try {
      final (nextItems, nextTotal) = await (
        _repository.getBriefGlyphProperties(page: currentPage, filter: filter),
