...
part of 'pickpocketing_loot_template_linked_list_view_model.dart';

mixin _PickpocketingLootTemplateLinkedListViewModelMixin
  ...
  Future<void> create() async {
    ...
    errorMessage.value = null;
    try {
      final candidate = await _repository.createPickpocketingLootTemplate(link);
      if (token != _interactionToken || linkKey.value != link) return;
  ...
  Future<void> setLinkKey(int linkKey) async {
    ...
    editingKey.value = null;
    selectedKey.value = null;
    _applyCandidate(PickpocketingLootTemplateEntity(entry: link));
    await _refresh();
  }
  ...
  Future<void> _refresh() async {
    ...
    errorMessage.value = null;
    try {
      final count = await _repository.countPickpocketingLootTemplates(link);
