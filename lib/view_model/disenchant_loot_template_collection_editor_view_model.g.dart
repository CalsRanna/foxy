...
mixin _DisenchantLootTemplateCollectionEditorViewModelMixin
  ...
  Future<void> create() async {
    ...
    errorMessage.value = null;
    try {
      final candidate = await _repository.createDisenchantLootTemplate(parent);
      if (token != _interactionToken || parentKey.value != parent) return;
  ...
  Future<void> setParentKey(int parentKey) async {
    ...
    editingKey.value = null;
    selectedKey.value = null;
    _applyCandidate(DisenchantLootTemplateEntity(entry: parent));
    await _refresh();
  }
  ...
  Future<void> _refresh() async {
    ...
    errorMessage.value = null;
    try {
      final count = await _repository.countDisenchantLootTemplates(parent);
