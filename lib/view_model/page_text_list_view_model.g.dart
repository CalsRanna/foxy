...
part of 'page_text_list_view_model.dart';

mixin _PageTextListViewModelMixin on FieldControllerMixin, QueryVersionMixin {
  final _repository = GetIt.instance.get<PageTextRepository>();

  final items = signal(<BriefPageTextEntity>[]);
  ...
  Future<void> _refresh() async {
    ...
    try {
      final (nextItems, nextTotal) = await (
        _repository.getBriefPageTexts(page: currentPage, filter: filter),
