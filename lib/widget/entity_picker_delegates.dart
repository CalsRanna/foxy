...
class EntityPickerDelegates {
  ...
  static final creatureSpellData = EntityPickerDelegate<BriefCreatureSpellDataEntity>(
    title: '宠物技能',
    errorLabel: '搜索宠物技能失败',
  ...
  static final creatureTemplate = EntityPickerDelegate<BriefCreatureTemplateEntity>(
    title: '生物模板',
    errorLabel: '搜索生物模板失败',
  ...
  static final itemEnchantmentTemplate = EntityPickerDelegate<BriefItemEnchantmentTemplateEntity>(
    title: '附魔',
    errorLabel: '搜索附魔失败',
    filters: const [EntityPickerFilter('编号'), EntityPickerFilter('名称')],
    columns: [
  ...
  static final itemRandomProperties = EntityPickerDelegate<ItemRandomPropertiesEntity>(
    title: '随机属性',
    errorLabel: '搜索随机属性失败',
  ...
  static final scalingStatDistribution = EntityPickerDelegate<BriefItemEnchantmentTemplateEntity>(
    title: '属性缩放分布',
    errorLabel: '搜索缩放分布失败',
    filters: const [EntityPickerFilter('编号')],
    columns: [
