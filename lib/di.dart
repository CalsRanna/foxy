...
class DI {
  static void ensureInitialized() {
    ...
    GetIt.instance.registerLazySingleton(() => AchievementRepository());
    GetIt.instance.registerLazySingleton(() => ActivityLogRepository());
    GetIt.instance.registerLazySingleton(() => AreaTableRepository());
    GetIt.instance.registerLazySingleton(() => BroadcastTextRepository());
    GetIt.instance.registerLazySingleton(() => CharTitleRepository());
    GetIt.instance.registerLazySingleton(() => ConditionRepository());
    GetIt.instance.registerLazySingleton(() => CreatureDisplayInfoRepository());
    GetIt.instance.registerLazySingleton(() => CreatureEquipTemplateRepository());
    GetIt.instance.registerLazySingleton(() => CreatureModelInfoRepository());
    GetIt.instance.registerLazySingleton(() => CreatureOnKillReputationRepository());
    GetIt.instance.registerLazySingleton(() => CreatureQuestEnderRepository());
    GetIt.instance.registerLazySingleton(() => CreatureQuestItemRepository());
    GetIt.instance.registerLazySingleton(() => CreatureQuestStarterRepository());
    GetIt.instance.registerLazySingleton(() => CreatureSpellDataRepository());
    GetIt.instance.registerLazySingleton(() => CreatureTemplateAddonRepository());
    GetIt.instance.registerLazySingleton(() => CreatureTemplateRepository());
    GetIt.instance.registerLazySingleton(() => CreatureTemplateResistanceRepository());
    GetIt.instance.registerLazySingleton(() => CreatureTemplateSpellRepository());
    GetIt.instance.registerLazySingleton(() => CurrencyTypeRepository());
    GetIt.instance.registerLazySingleton(() => DbcFactionRepository());
    GetIt.instance.registerLazySingleton(() => EmoteTextRepository());
    GetIt.instance.registerLazySingleton(() => FeatureRepository());
    GetIt.instance.registerLazySingleton(() => GameObjectQuestEnderRepository());
    GetIt.instance.registerLazySingleton(() => GameObjectQuestItemRepository());
    GetIt.instance.registerLazySingleton(() => GameObjectQuestStarterRepository());
    GetIt.instance.registerLazySingleton(() => GameObjectTemplateAddonRepository());
    GetIt.instance.registerLazySingleton(() => GameObjectTemplateRepository());
    GetIt.instance.registerLazySingleton(() => GemPropertyRepository());
    GetIt.instance.registerLazySingleton(() => GlyphPropertyRepository());
    GetIt.instance.registerLazySingleton(() => GossipMenuOptionLocaleRepository());
    GetIt.instance.registerLazySingleton(() => GossipMenuOptionRepository());
    GetIt.instance.registerLazySingleton(() => GossipMenuRepository());
    GetIt.instance.registerLazySingleton(() => ItemDisplayInfoRepository());
    GetIt.instance.registerLazySingleton(() => ItemEnchantmentTemplateRepository());
    GetIt.instance.registerLazySingleton(() => ItemExtendedCostRepository());
    GetIt.instance.registerLazySingleton(() => ItemRandomPropertiesRepository());
    GetIt.instance.registerLazySingleton(() => ItemRandomSuffixRepository());
    GetIt.instance.registerLazySingleton(() => ItemSetRepository());
    GetIt.instance.registerLazySingleton(() => ItemTemplateLocaleRepository());
    GetIt.instance.registerLazySingleton(() => ItemTemplateRepository());
    GetIt.instance.registerLazySingleton(() => LockRepository());
    GetIt.instance.registerLazySingleton(() => MapInfoRepository());
    GetIt.instance.registerLazySingleton(() => NpcTextLocaleRepository());
    GetIt.instance.registerLazySingleton(() => NpcTextRepository());
    GetIt.instance.registerLazySingleton(() => NpcTrainerRepository());
    GetIt.instance.registerLazySingleton(() => NpcVendorRepository());
    GetIt.instance.registerLazySingleton(() => PageTextRepository());
    GetIt.instance.registerLazySingleton(() => PlayerCreateInfoRepository());
    GetIt.instance.registerLazySingleton(() => QuestFactionRewardRepository());
    GetIt.instance.registerLazySingleton(() => QuestInfoRepository());
    GetIt.instance.registerLazySingleton(() => QuestOfferRewardLocaleRepository());
    GetIt.instance.registerLazySingleton(() => QuestOfferRewardRepository());
    GetIt.instance.registerLazySingleton(() => QuestRequestItemsLocaleRepository());
    GetIt.instance.registerLazySingleton(() => QuestRequestItemsRepository());
    GetIt.instance.registerLazySingleton(() => QuestSortRepository());
    GetIt.instance.registerLazySingleton(() => QuestTemplateAddonRepository());
    GetIt.instance.registerLazySingleton(() => QuestTemplateLocaleRepository());
    GetIt.instance.registerLazySingleton(() => QuestTemplateRepository());
    GetIt.instance.registerLazySingleton(() => ScalingStatDistributionRepository());
    GetIt.instance.registerLazySingleton(() => ScalingStatDistributionSoloRepository());
    GetIt.instance.registerLazySingleton(() => ScalingStatValueRepository());
    GetIt.instance.registerLazySingleton(() => SettingRepository());
    GetIt.instance.registerLazySingleton(() => SmartScriptRepository());
    GetIt.instance.registerLazySingleton(() => SpellAreaRepository());
    GetIt.instance.registerLazySingleton(() => SpellBonusDataRepository());
    GetIt.instance.registerLazySingleton(() => SpellCustomAttrRepository());
    GetIt.instance.registerLazySingleton(() => SpellDurationRepository());
    GetIt.instance.registerLazySingleton(() => SpellGroupRepository());
    GetIt.instance.registerLazySingleton(() => SpellIconRepository());
    GetIt.instance.registerLazySingleton(() => SpellItemEnchantmentSoloRepository());
    GetIt.instance.registerLazySingleton(() => SpellLinkedSpellRepository());
    GetIt.instance.registerLazySingleton(() => SpellLootTemplateRepository());
    GetIt.instance.registerLazySingleton(() => SpellRangeRepository());
    GetIt.instance.registerLazySingleton(() => SpellRankRepository());
    GetIt.instance.registerLazySingleton(() => SpellRepository());
    GetIt.instance.registerLazySingleton(() => TalentRepository());
    GetIt.instance.registerLazySingleton(() => VehicleRepository());
    GetIt.instance.registerLazySingleton(() => VersionRepository());
    GetIt.instance.registerLazySingleton(() => WaypointDataRepository());
