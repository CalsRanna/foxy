...
class DI {
  ...
  static void _registerViewModels() {
    ...
    _instance.registerLazySingleton(() => ScaffoldViewModel());
    _instance.registerSingleton(DbcImportViewModel());
    _instance.registerFactory(() => DashboardViewModel());
    _instance.registerLazySingleton(() => MoreViewModel());
    _instance.registerLazySingleton(() => CreatureTemplateListViewModel());
    ...
    _instance.registerLazySingleton(() => GameObjectTemplateListViewModel());
    ...
    _instance.registerLazySingleton(() => ItemTemplateListViewModel());
    ...
    _instance.registerLazySingleton(() => GossipMenuListViewModel());
    _instance.registerLazySingleton(() => QuestTemplateListViewModel());
    ...
    _instance.registerLazySingleton(() => SmartScriptListViewModel());
    _instance.registerFactory(() => SmartScriptDetailViewModel());
    _instance.registerLazySingleton(() => SpellListViewModel());
    ...
    _instance.registerLazySingleton(() => ReferenceLootTemplateListViewModel());
    _instance.registerFactory(() => ReferenceLootTemplateDetailViewModel());
    _instance.registerLazySingleton(() => PageTextListViewModel());
    _instance.registerFactory(() => PageTextDetailViewModel());
    _instance.registerFactory(() => PageTextLocaleViewModel());
    _instance.registerLazySingleton(() => ConditionListViewModel());
    _instance.registerFactory(() => ConditionDetailViewModel());
    _instance.registerLazySingleton(() => PlayerCreateInfoListViewModel());
    ...
    _instance.registerLazySingleton(() => AreaTableListViewModel());
    _instance.registerFactory(() => AreaTableDetailViewModel());
    _instance.registerLazySingleton(() => EmoteTextListViewModel());
    _instance.registerFactory(() => EmoteTextDetailViewModel());
    _instance.registerLazySingleton(() => QuestFactionRewardListViewModel());
    _instance.registerFactory(() => QuestFactionRewardDetailViewModel());
    _instance.registerLazySingleton(() => QuestSortListViewModel());
    _instance.registerFactory(() => QuestSortDetailViewModel());
    _instance.registerLazySingleton(() => QuestInfoListViewModel());
    _instance.registerFactory(() => QuestInfoDetailViewModel());
    _instance.registerLazySingleton(() => ItemExtendedCostListViewModel());
    ...
    _instance.registerLazySingleton(() => SpellItemEnchantmentListViewModel());
    _instance.registerFactory(() => SpellItemEnchantmentDetailViewModel());
    _instance.registerLazySingleton(() => GemPropertyListViewModel());
    _instance.registerFactory(() => GemPropertyDetailViewModel());
    _instance.registerLazySingleton(() => GlyphPropertyListViewModel());
    _instance.registerFactory(() => GlyphPropertyDetailViewModel());
    _instance.registerLazySingleton(() => TalentListViewModel());
    _instance.registerFactory(() => TalentDetailViewModel());
    _instance.registerLazySingleton(() => CurrencyTypeListViewModel());
    _instance.registerFactory(() => CurrencyTypeDetailViewModel());
    _instance.registerLazySingleton(() => ScalingStatValueListViewModel());
    _instance.registerFactory(() => ScalingStatValueDetailViewModel());
    _instance.registerLazySingleton(() => ItemSetListViewModel());
    _instance.registerFactory(() => ItemSetDetailViewModel());
    _instance.registerLazySingleton(() => AchievementListViewModel());
