...
part 'item_bag_family_entity.g.dart';

@FoxyFullEntity(table: 'foxy.dbc_item_bag_family')
class ItemBagFamilyEntity with _ItemBagFamilyEntityMixin {
  ...
  factory ItemBagFamilyEntity.fromJson(Map<String, dynamic> json) =>
      _ItemBagFamilyEntityMixin.fromJson(json);
}
