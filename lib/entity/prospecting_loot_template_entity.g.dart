...
part of 'prospecting_loot_template_entity.dart';

final class BriefProspectingLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefProspectingLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefProspectingLootTemplateEntity.fromJson(
    Map<String, dynamic> json,
  ) {
    return BriefProspectingLootTemplateEntity(
  ...
  ProspectingLootTemplateKey get key {
    return ProspectingLootTemplateKey(entry: entry, item: item);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefProspectingLootTemplateEntity &&
            entry == other.entry &&
            item == other.item &&
...
mixin _ProspectingLootTemplateEntityMixin {
  @override
  int get hashCode {
    final self = this as ProspectingLootTemplateEntity;
  ...
  bool operator ==(Object other) {
    ...
    return identical(self, other) ||
        other is ProspectingLootTemplateEntity &&
  ...
  ProspectingLootTemplateEntity copyWith({
    int? entry,
    int? item,
    int? reference,
    double? chance,
  ...
  static ProspectingLootTemplateEntity fromJson(Map<String, dynamic> json) {
    return ProspectingLootTemplateEntity(
      entry: (json['Entry'] as num?)?.toInt() ?? 0,
      item: (json['Item'] as num?)?.toInt() ?? 0,
      reference: (json['Reference'] as num?)?.toInt() ?? 0,
