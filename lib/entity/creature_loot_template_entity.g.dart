...
part of 'creature_loot_template_entity.dart';

final class BriefCreatureLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefCreatureLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefCreatureLootTemplateEntity.fromJson(Map<String, dynamic> json) {
    return BriefCreatureLootTemplateEntity(
  ...
  CreatureLootTemplateKey get key {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefCreatureLootTemplateEntity &&
            entry == other.entry &&
            item == other.item &&
...
mixin _CreatureLootTemplateEntityMixin {
  @override
  int get hashCode {
    final self = this as CreatureLootTemplateEntity;
  ...
  bool operator ==(Object other) {
    ...
    return identical(self, other) ||
        other is CreatureLootTemplateEntity &&
  ...
  CreatureLootTemplateEntity copyWith({
    int? entry,
    int? item,
    int? reference,
    double? chance,
  ...
  static CreatureLootTemplateEntity fromJson(Map<String, dynamic> json) {
    return CreatureLootTemplateEntity(
      entry: json['Entry'] == true
          ? 1
          : json['Entry'] == false
