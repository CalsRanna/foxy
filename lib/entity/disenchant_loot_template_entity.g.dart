...
final class BriefDisenchantLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefDisenchantLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefDisenchantLootTemplateEntity.fromJson(
    Map<String, dynamic> json,
  ) {
    return BriefDisenchantLootTemplateEntity(
  ...
  DisenchantLootTemplateKey get key {
    return DisenchantLootTemplateKey(entry: entry, item: item);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefDisenchantLootTemplateEntity &&
            entry == other.entry &&
            item == other.item &&
...
mixin _DisenchantLootTemplateEntityMixin {
  @override
  int get hashCode {
    final self = this as DisenchantLootTemplateEntity;
