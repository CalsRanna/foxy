...
part 'totem_category_entity.g.dart';

@FoxyBriefEntity()
@FoxyBriefField.text('name')
@FoxyFullEntity(table: 'foxy.dbc_totem_category')
class TotemCategoryEntity with _TotemCategoryEntityMixin {
  @FoxyBriefField()
  ...
  @FoxyBriefField()
  @FoxyFullField('TotemCategoryType')
  final int categoryType;

  @FoxyBriefField()
  @FoxyFullField('TotemCategoryMask')
  final int categoryMask;

  const TotemCategoryEntity({
    this.id = 0,
    this.nameLangEnUS = '',
    this.nameLangKoKR = '',
    this.nameLangFrFR = '',
  ...
  factory TotemCategoryEntity.fromJson(Map<String, dynamic> json) =>
      _TotemCategoryEntityMixin.fromJson(json);
}
