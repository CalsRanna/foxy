...
part of 'reference_loot_template_entity.dart';

final class BriefReferenceLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefReferenceLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefReferenceLootTemplateEntity.fromJson(Map<String, dynamic> json) {
    return BriefReferenceLootTemplateEntity(
  ...
  ReferenceLootTemplateKey get key {
    return ReferenceLootTemplateKey(entry: entry, item: item);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefReferenceLootTemplateEntity &&
            entry == other.entry &&
            item == other.item &&
...
mixin _ReferenceLootTemplateEntityMixin {
  @override
  int get hashCode {
    final self = this as ReferenceLootTemplateEntity;
  ...
  bool operator ==(Object other) {
    ...
    return identical(self, other) ||
        other is ReferenceLootTemplateEntity &&
  ...
  ReferenceLootTemplateEntity copyWith({
    int? entry,
    int? item,
    int? reference,
    double? chance,
  ...
  static ReferenceLootTemplateEntity fromJson(Map<String, dynamic> json) {
    return ReferenceLootTemplateEntity(
      entry: (json['Entry'] as num?)?.toInt() ?? 0,
      item: (json['Item'] as num?)?.toInt() ?? 0,
      reference: (json['Reference'] as num?)?.toInt() ?? 0,
