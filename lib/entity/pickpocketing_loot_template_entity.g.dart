...
final class BriefPickpocketingLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefPickpocketingLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefPickpocketingLootTemplateEntity.fromJson(
    Map<String, dynamic> json,
  ) {
    return BriefPickpocketingLootTemplateEntity(
  ...
  PickpocketingLootTemplateKey get key {
    return PickpocketingLootTemplateKey(entry: entry, item: item);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefPickpocketingLootTemplateEntity &&
            entry == other.entry &&
            item == other.item &&
