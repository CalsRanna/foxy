...
part 'currency_category_entity.g.dart';

@FoxyBriefEntity()
@FoxyFullEntity(table: 'foxy.dbc_currency_category')
class CurrencyCategoryEntity with _CurrencyCategoryEntityMixin {
  @FoxyBriefField()
  ...
  factory CurrencyCategoryEntity.fromJson(Map<String, dynamic> json) =>
      _CurrencyCategoryEntityMixin.fromJson(json);
}
