...
part of 'item_loot_template_entity.dart';

mixin _ItemLootTemplateEntityMixin {
  static ItemLootTemplateEntity fromJson(Map<String, dynamic> json) {
  ...
  ItemLootTemplateEntity copyWith({
    ...
    final self = this as ItemLootTemplateEntity;
    return ItemLootTemplateEntity(
  ...
  bool operator ==(Object other) {
    ...
    return identical(self, other) ||
        other is ItemLootTemplateEntity &&
...
final class BriefItemLootTemplateEntity {
  final int entry;
  final int item;
  final int reference;
  final double chance;
  ...
  const BriefItemLootTemplateEntity({
    this.entry = 0,
    this.item = 0,
    this.reference = 0,
    this.chance = 100.0,
  ...
  factory BriefItemLootTemplateEntity.fromJson(Map<String, dynamic> json) {
