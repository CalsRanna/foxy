...
part of 'item_bag_family_entity.dart';

mixin _ItemBagFamilyEntityMixin {
  static ItemBagFamilyEntity fromJson(Map<String, dynamic> json) {
    return ItemBagFamilyEntity(
  ...
  ItemBagFamilyEntity copyWith({
    ...
    final self = this as ItemBagFamilyEntity;
    return ItemBagFamilyEntity(
      id: id ?? self.id,
