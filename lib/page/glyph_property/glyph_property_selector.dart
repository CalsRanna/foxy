...
import 'package:foxy/page/glyph_property/glyph_property_selector_view_model.dart';
...
class _GlyphPropertySelectorState extends State<GlyphPropertySelector> {
  ...
  Future<void> _openDialog() async {
    final vm = GlyphPropertySelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final GlyphPropertySelectorViewModel vm;
