...
import 'package:foxy/page/glyph_property/glyph_property_selector_controller.dart';
...
class GlyphPropertySelector extends StatefulWidget {
  ...
  const GlyphPropertySelector({super.key, required this.controller, this.placeholder});
...
class _GlyphPropertySelectorState extends State<GlyphPropertySelector> {
  ...
  Future<void> _openDialog() async {
    final controller = GlyphPropertySelectorController();
...
class _Dialog extends StatefulWidget {
  final GlyphPropertySelectorController controller;
