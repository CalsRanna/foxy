        ...
        return FoxyShadTable(
          builder: (context, vicinity) {
            ...
            return switch (vicinity.column) {
              ...
              1 => ShadTableCell(child: Text(item.tabId.toString())),
              2 => ShadTableCell(child: Text(item.tierId.toString())),
              3 => ShadTableCell(child: Text(item.columnIndex.toString())),
              4 => ShadTableCell(child: Text(item.spellRank0.toString())),
            ...
            showFoxyContextMenu(
              ...
              items: [
                ...
                ShadContextMenuItem(
                  ...
                  onPressed: () {
                    viewModel.copyTalent(items[row].id);
                  },
                  child: Text('复制'),
                ),
                ShadContextMenuItem(
                  ...
                  onPressed: () {
                    viewModel.deleteTalent(items[row].id);
                  },
                  child: Text('删除'),
                ),
              ],
