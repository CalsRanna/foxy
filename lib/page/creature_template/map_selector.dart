...
import 'package:foxy/page/creature_template/map_selector_view_model.dart';
...
class MapSelector extends StatefulWidget {
  ...
  const MapSelector({super.key, required this.signal, this.placeholder});
      ...
      child: Row(spacing: 8, children: [
        Expanded(
          child: ShadInput(
            ...
            placeholder: Text('地图ID'),
          ),
        ),
        Expanded(
          child: ShadInput(
            controller: _nameController,
            placeholder: Text('地图名称'),
          ),
        ),
        Expanded(
          child: Row(spacing: 8, children: [
            ...
            return FoxyShadTable(
              ...
              header: (context, column) {
                return switch (column) {
                  ...
                  2 => ShadTableCell.header(child: Text('类型')),
                  3 => ShadTableCell.header(child: Text('PVP')),
              ...
              builder: (context, vicinity) {
                ...
                return switch (vicinity.column) {
                  ...
                  1 => ShadTableCell(
                    child: Text(
                      item.mapNameLangZhCn,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
                  2 => ShadTableCell(child: Text(item.instanceType.toString())),
                  3 => ShadTableCell(child: Text(item.pvp.toString())),
