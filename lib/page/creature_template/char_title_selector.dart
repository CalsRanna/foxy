...
import 'package:foxy/page/creature_template/char_title_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class CharTitleSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const CharTitleSelector({
    super.key,
  ...
  @override
  State<CharTitleSelector> createState() => _CharTitleSelectorState();
}

class _CharTitleSelectorState extends State<CharTitleSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = CharTitleSelectorController();
...
class _Dialog extends StatefulWidget {
  final CharTitleSelectorController controller;
      ...
      child: Row(spacing: 8, children: [
        Expanded(
          child: ShadInput(
            ...
            placeholder: Text('称号ID'),
          ),
        ),
        Expanded(
          child: ShadInput(
            controller: _nameController,
            placeholder: Text('称号名称'),
          ),
        ),
        Expanded(
          child: Row(spacing: 8, children: [
