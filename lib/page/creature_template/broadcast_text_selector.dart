...
import 'package:foxy/page/creature_template/broadcast_text_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class BroadcastTextSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const BroadcastTextSelector({
    super.key,
  ...
  @override
  State<BroadcastTextSelector> createState() => _BroadcastTextSelectorState();
}

class _BroadcastTextSelectorState extends State<BroadcastTextSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = BroadcastTextSelectorController();
...
class _Dialog extends StatefulWidget {
  final BroadcastTextSelectorController controller;
          ...
          child: Row(spacing: 8, children: [
            ShadButton(
              onPressed: () {
                ...
                widget.controller.textFilter = _textController.text;
            ...
            return FoxyShadTable(
              ...
              header: (context, column) {
                return switch (column) {
                  ...
                  1 => ShadTableCell.header(child: Text('文本')),
                  2 => ShadTableCell.header(child: Text('语言')),
              ...
              columnSpanExtent: (column) {
                return switch (column) {
                  ...
                  1 => FixedTableSpanExtent(textWidth),
              ...
              builder: (context, vicinity) {
                ...
                return switch (vicinity.column) {
                  ...
                  2 => ShadTableCell(child: Text(item.languageId.toString())),
