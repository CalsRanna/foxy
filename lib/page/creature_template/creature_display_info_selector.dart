...
import 'package:foxy/page/creature_template/creature_display_info_selector_controller.dart';
...
class _CreatureDisplayInfoSelectorState
  ...
  Future<void> _openDialog() async {
    final controller = CreatureDisplayInfoSelectorController();
...
class _Dialog extends StatefulWidget {
  final CreatureDisplayInfoSelectorController controller;
          ...
          child: Row(spacing: 8, children: [
            ShadButton(
              onPressed: () {
                ...
                widget.controller.modelNameFilter = _modelNameController.text;
