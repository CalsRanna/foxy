...
import 'package:foxy/page/creature_template/creature_display_info_selector_view_model.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';
import 'package:signals/signals_flutter.dart';

class CreatureDisplayInfoSelector extends StatefulWidget {
  ...
  @override
  State<CreatureDisplayInfoSelector> createState() =>
      _CreatureDisplayInfoSelectorState();
}

class _CreatureDisplayInfoSelectorState
  ...
  Future<void> _openDialog() async {
    final vm = CreatureDisplayInfoSelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final CreatureDisplayInfoSelectorViewModel vm;
...
class _DialogState extends State<_Dialog> {
  ...
  void initState() {
    ...
    _modelNameController.text = widget.vm.modelNameFilter.value;
  }
          ...
          child: Row(spacing: 8, children: [
            ShadButton(
              onPressed: () {
                ...
                widget.vm.modelNameFilter.value = _modelNameController.text;
