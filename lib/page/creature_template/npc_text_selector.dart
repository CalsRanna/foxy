...
import 'package:foxy/page/creature_template/npc_text_selector_controller.dart';
...
class _NpcTextSelectorState extends State<NpcTextSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = NpcTextSelectorController();
...
class _Dialog extends StatefulWidget {
  final NpcTextSelectorController controller;
