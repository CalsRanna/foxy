...
import 'package:foxy/page/creature_template/vehicle_selector_controller.dart';
...
class _VehicleSelectorState extends State<VehicleSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = VehicleSelectorController();
...
class _Dialog extends StatefulWidget {
  final VehicleSelectorController controller;
