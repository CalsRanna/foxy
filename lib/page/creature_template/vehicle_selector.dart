...
class _VehicleSelectorState extends State<VehicleSelector> {
  ...
  Future<void> _openDialog() async {
    ...
    final result = await showShadDialog<int>(
      context: context,
      builder: (context) {
        return _VehicleSelectorDialog(initialValue: currentValue);
      },
    );
    if (result != null) {
...
class _VehicleSelectorDialog extends StatefulWidget {
  final int? initialValue;

  const _VehicleSelectorDialog({this.initialValue});

  @override
  State<_VehicleSelectorDialog> createState() => _VehicleSelectorDialogState();
}

class _VehicleSelectorDialogState extends State<_VehicleSelectorDialog> {
    ...
    return FoxyShadTable(
      ...
      header: (context, column) {
        return switch (column) {
          ...
          1 => ShadTableCell.header(child: Text('标识')),
          2 => ShadTableCell.header(child: Text('转向速度')),
      ...
      builder: (context, vicinity) {
        ...
        return switch (vicinity.column) {
          ...
          1 => ShadTableCell(child: Text(item.flags.toString())),
          2 => ShadTableCell(child: Text(item.turnSpeed.toString())),
