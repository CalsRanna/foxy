...
import 'package:foxy/page/creature_template/dbc_faction_selector_controller.dart';
...
class _DbcFactionSelectorState extends State<DbcFactionSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = DbcFactionSelectorController();
...
class _Dialog extends StatefulWidget {
  final DbcFactionSelectorController controller;
