...
import 'package:foxy/page/creature_template/dbc_faction_selector_view_model.dart';
...
class _DbcFactionSelectorState extends State<DbcFactionSelector> {
  ...
  Future<void> _openDialog() async {
    final vm = DbcFactionSelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final DbcFactionSelectorViewModel vm;
