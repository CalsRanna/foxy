...
class _BasicSetting extends StatefulWidget {
  ...
  const _BasicSetting({required this.setting, this.onPressed});

  @override
  State<_BasicSetting> createState() => _BasicSettingState();
}

class _BasicSettingState extends State<_BasicSetting> {
