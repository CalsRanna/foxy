...
import 'package:foxy/page/quest_info/quest_info_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class QuestInfoSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const QuestInfoSelector({super.key, required this.controller, this.placeholder});

  @override
  State<QuestInfoSelector> createState() => _QuestInfoSelectorState();
}

class _QuestInfoSelectorState extends State<QuestInfoSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = QuestInfoSelectorController();
...
class _Dialog extends StatefulWidget {
  final QuestInfoSelectorController controller;
      ...
      child: Row(spacing: 8, children: [
        Expanded(
          child: ShadInput(
            ...
            placeholder: Text('任务信息ID'),
          ),
        ),
        Expanded(
          child: ShadInput(
            controller: _nameController,
            placeholder: Text('信息名称'),
          ),
        ),
        Expanded(
          child: Row(spacing: 8, children: [
