...
import 'package:foxy/page/area_table/area_table_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class AreaTableSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const AreaTableSelector({super.key, required this.controller, this.placeholder});

  @override
  State<AreaTableSelector> createState() => _AreaTableSelectorState();
}
...
class _AreaTableSelectorState extends State<AreaTableSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = AreaTableSelectorController();
...
class _Dialog extends StatefulWidget {
  final AreaTableSelectorController controller;
            ...
            return FoxyShadTable(
              ...
              header: (context, column) {
                return switch (column) {
                  ...
                  2 => ShadTableCell.header(child: Text('地区编号')),
