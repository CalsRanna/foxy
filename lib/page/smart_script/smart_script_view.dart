    ...
    final basicRows = [
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.entryOrGuidController,
              label: '实体编号',
          ...
          Expanded(
            child: FormItem(
              controller: vm.sourceTypeController,
              label: '源类型',
    ...
    final eventRows = [
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.eventTypeController,
              label: '事件类型',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventPhaseMaskController,
              label: '阶段掩码',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventChanceController,
              label: '触发几率',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventFlagsController,
              label: '事件标识',
      ...
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.eventParam1Controller,
              label: '事件参数1',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventParam2Controller,
              label: '事件参数2',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventParam3Controller,
              label: '事件参数3',
          ...
          Expanded(
            child: FormItem(
              controller: vm.eventParam4Controller,
              label: '事件参数4',
      ...
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.eventParam5Controller,
              label: '事件参数5',
    ...
    final actionRows = [
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.actionTypeController,
              label: '动作类型',
          ...
          Expanded(
            child: FormItem(
              controller: vm.actionParam1Controller,
              label: '动作参数1',
          ...
          Expanded(
            child: FormItem(
              controller: vm.actionParam2Controller,
              label: '动作参数2',
          ...
          Expanded(
            child: FormItem(
              controller: vm.actionParam3Controller,
              label: '动作参数3',
      ...
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.actionParam4Controller,
              label: '动作参数4',
          ...
          Expanded(
            child: FormItem(
              controller: vm.actionParam5Controller,
              label: '动作参数5',
          ...
          Expanded(
            child: FormItem(
              controller: vm.actionParam6Controller,
              label: '动作参数6',
    ...
    final targetRows = [
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.targetTypeController,
              label: '目标类型',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetParam1Controller,
              label: '目标参数1',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetParam2Controller,
              label: '目标参数2',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetParam3Controller,
              label: '目标参数3',
      ...
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.targetParam4Controller,
              label: '目标参数4',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetXController,
              label: 'X坐标',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetYController,
              label: 'Y坐标',
          ...
          Expanded(
            child: FormItem(
              controller: vm.targetZController,
              label: 'Z坐标',
      ...
      Row(
        ...
        children: [
          Expanded(
            child: FormItem(
              controller: vm.targetOController,
              label: '朝向',
