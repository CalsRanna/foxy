...
import 'package:foxy/page/smart_script/waypoint_data_selector_controller.dart';
...
class WaypointDataSelector extends StatefulWidget {
  ...
  const WaypointDataSelector({super.key, required this.controller, this.placeholder});
...
class _WaypointDataSelectorState extends State<WaypointDataSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = WaypointDataSelectorController();
...
class _Dialog extends StatefulWidget {
  final WaypointDataSelectorController controller;
