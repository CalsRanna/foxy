...
import 'package:foxy/page/emote_text/emote_selector_view_model.dart';
...
class EmoteSelector extends StatefulWidget {
  ...
  const EmoteSelector({super.key, required this.signal, this.placeholder});
...
class _EmoteSelectorState extends State<EmoteSelector> {
  ...
  Future<void> _openDialog() async {
    final vm = EmoteSelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final EmoteSelectorViewModel vm;
