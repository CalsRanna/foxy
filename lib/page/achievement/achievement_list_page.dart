...
class AchievementListPage extends StatefulWidget {
  const AchievementListPage({super.key});
...
class _AchievementListPageState extends State<AchievementListPage> {
  final viewModel = GetIt.instance.get<AchievementListViewModel>();
  ...
  Widget _buildTable() {
    ...
    final items = viewModel.achievements.value;
            ...
            showFoxyContextMenu(
              ...
              items: [
                ...
                ShadContextMenuItem(
                  ...
                  onPressed: () {
                    viewModel.copyAchievement(items[row].id);
                  },
                  child: Text('复制'),
                ),
                ShadContextMenuItem(
                  ...
                  onPressed: () {
                    viewModel.deleteAchievement(items[row].id);
                  },
                  child: Text('删除'),
                ),
              ],
