...
import 'package:foxy/page/spell/spell_range_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class SpellRangeSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const SpellRangeSelector({super.key, required this.controller, this.placeholder});

  @override
  State<SpellRangeSelector> createState() => _SpellRangeSelectorState();
}
...
class _SpellRangeSelectorState extends State<SpellRangeSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = SpellRangeSelectorController();
...
class _Dialog extends StatefulWidget {
  final SpellRangeSelectorController controller;
      ...
      child: Row(spacing: 8, children: [
        Expanded(
          child: ShadInput(
            ...
            placeholder: Text('射程ID'),
          ),
        ),
        Expanded(
          child: ShadInput(
            controller: _nameController,
            placeholder: Text('射程名称'),
          ),
        ),
        Expanded(
          child: Row(spacing: 8, children: [
            ...
            return FoxyShadTable(
              ...
              header: (context, column) {
                return switch (column) {
                  ...
                  2 => ShadTableCell.header(child: Text('最小射程')),
                  3 => ShadTableCell.header(child: Text('最大射程')),
