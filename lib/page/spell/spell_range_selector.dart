...
class _DialogState extends State<_Dialog> {
  ...
  Future<void> _search() async {
    try {
      final repository = SpellRangeRepository();
      ...
      final items = await repository.getSpellRanges(
        id: id,
        name: name,
        page: _page,
      );
      final total = await repository.countSpellRanges(id: id, name: name);
      if (mounted) {
        setState(() {
          _items = items;
          _total = total;
