...
class _DialogState extends State<_Dialog> {
  ...
  Future<void> _search() async {
    try {
      final repository = SpellIconRepository();
      ...
      final items = await repository.getSpellIcons(
        id: id,
        name: name,
        page: _page,
      );
      final total = await repository.countSpellIcons(id: id, name: name);
      if (mounted) {
        setState(() {
          _items = items;
          _total = total;
