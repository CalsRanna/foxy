...
import 'package:foxy/page/spell/spell_icon_selector_controller.dart';
...
class _SpellIconSelectorState extends State<SpellIconSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = SpellIconSelectorController();
...
class _Dialog extends StatefulWidget {
  final SpellIconSelectorController controller;
