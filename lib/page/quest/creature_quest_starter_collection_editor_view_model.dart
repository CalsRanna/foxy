...
class CreatureQuestStarterCollectionEditorViewModel
  ...
  CreatureQuestStarterEntity _collectCandidate() => CreatureQuestStarterEntity(
    id: idController.collect(),
    quest: questController.collect(),
  );

  void _applyCandidate(CreatureQuestStarterEntity model) {
  ...
  Future<void> _refresh() async {
    ...
    try {
      ...
      final data = await _repository.getBriefCreatureQuestStarters(parent, page: nextPage);
      if (token != _refreshToken) return;
      page.value = nextPage;
      items.value = data;
      total.value = count;
