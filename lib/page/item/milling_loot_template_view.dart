...
class MillingLootTemplateView extends StatefulWidget {
  ...
  const MillingLootTemplateView({super.key, required this.parentKey});
...
class _MillingLootTemplateViewState extends State<MillingLootTemplateView> {
  final viewModel = GetIt.instance
      .get<MillingLootTemplateCollectionEditorViewModel>();
  ...
  Future<void> _destroy(MillingLootTemplateKey key) async {
  ...
  Future<bool> _load(MillingLootTemplateKey key) async {
    try {
