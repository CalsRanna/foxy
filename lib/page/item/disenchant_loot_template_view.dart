...
class _DisenchantLootTemplateViewState
  ...
  final viewModel = GetIt.instance.get<DisenchantLootTemplateViewModel>();

  @override
  void initState() {
    super.initState();
    viewModel.initSignals(disenchantId: widget.entry);
  }
