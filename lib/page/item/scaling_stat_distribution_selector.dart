...
import 'package:foxy/page/item/scaling_stat_distribution_selector_controller.dart';
...
class ScalingStatDistributionSelector extends StatefulWidget {
  ...
  const ScalingStatDistributionSelector({super.key, required this.controller, this.placeholder});

  @override
  State<ScalingStatDistributionSelector> createState() => _ScalingStatDistributionSelectorState();
}

class _ScalingStatDistributionSelectorState extends State<ScalingStatDistributionSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = ScalingStatDistributionSelectorController();
...
class _Dialog extends StatefulWidget {
  final ScalingStatDistributionSelectorController controller;
