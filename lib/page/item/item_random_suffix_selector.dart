...
import 'package:foxy/page/item/item_random_suffix_selector_controller.dart';
...
class ItemRandomSuffixSelector extends StatefulWidget {
  ...
  const ItemRandomSuffixSelector({super.key, required this.controller, this.placeholder});
...
class _ItemRandomSuffixSelectorState extends State<ItemRandomSuffixSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = ItemRandomSuffixSelectorController();
...
class _Dialog extends StatefulWidget {
  final ItemRandomSuffixSelectorController controller;
