...
class ItemRandomSuffixSelector extends StatefulWidget {
  ...
  const ItemRandomSuffixSelector({
    super.key,
  ...
  @override
  State<ItemRandomSuffixSelector> createState() =>
      _ItemRandomSuffixSelectorState();
}
...
class _DialogState extends State<_Dialog> {
  ...
  Future<void> _search() async {
    try {
      ...
      final total = await repository.countItemRandomSuffixes(
        id: id,
        name: name,
      );
      if (mounted) {
