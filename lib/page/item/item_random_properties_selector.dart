...
import 'package:foxy/page/item/item_random_properties_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class ItemRandomPropertiesSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const ItemRandomPropertiesSelector({super.key, required this.controller, this.placeholder});

  @override
  State<ItemRandomPropertiesSelector> createState() => _ItemRandomPropertiesSelectorState();
}

class _ItemRandomPropertiesSelectorState extends State<ItemRandomPropertiesSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = ItemRandomPropertiesSelectorController();
...
class _Dialog extends StatefulWidget {
  final ItemRandomPropertiesSelectorController controller;
      ...
      child: Row(spacing: 8, children: [
        Expanded(
          child: ShadInput(
            ...
            placeholder: Text('属性ID'),
          ),
        ),
        Expanded(
          child: ShadInput(
            controller: _nameController,
            placeholder: Text('属性名称'),
          ),
        ),
        Expanded(
          child: Row(spacing: 8, children: [
