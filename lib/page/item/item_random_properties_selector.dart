...
import 'package:foxy/page/item/item_random_properties_selector_view_model.dart';
...
class _ItemRandomPropertiesSelectorState extends State<ItemRandomPropertiesSelector> {
  ...
  Future<void> _openDialog() async {
    final vm = ItemRandomPropertiesSelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final ItemRandomPropertiesSelectorViewModel vm;
