...
class ItemRandomPropertiesSelector extends StatefulWidget {
  ...
  const ItemRandomPropertiesSelector({
    super.key,
  ...
  @override
  State<ItemRandomPropertiesSelector> createState() =>
      _ItemRandomPropertiesSelectorState();
}

class _ItemRandomPropertiesSelectorState
    extends State<ItemRandomPropertiesSelector> {
  @override
...
class _DialogState extends State<_Dialog> {
  ...
  Future<void> _search() async {
    try {
      final repository = ItemRandomPropertiesRepository();
      ...
      final items = await repository.getItemRandomProperties(
        id: id,
        name: name,
        page: _page,
      );
