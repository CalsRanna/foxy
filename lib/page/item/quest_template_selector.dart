...
import 'package:foxy/page/item/quest_template_selector_controller.dart';
...
class QuestTemplateSelector extends StatefulWidget {
  ...
  const QuestTemplateSelector({super.key, required this.controller, this.placeholder});
...
class _QuestTemplateSelectorState extends State<QuestTemplateSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = QuestTemplateSelectorController();
...
class _Dialog extends StatefulWidget {
  final QuestTemplateSelectorController controller;
