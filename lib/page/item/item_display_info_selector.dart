...
import 'package:foxy/page/item/item_display_info_selector_view_model.dart';
...
class _ItemDisplayInfoSelectorState extends State<ItemDisplayInfoSelector> {
  ...
  Future<void> _openDialog() async {
    final vm = ItemDisplayInfoSelectorViewModel();
...
class _Dialog extends StatefulWidget {
  final ItemDisplayInfoSelectorViewModel vm;
