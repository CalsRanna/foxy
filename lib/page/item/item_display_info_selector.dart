...
import 'package:foxy/page/item/item_display_info_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class ItemDisplayInfoSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const ItemDisplayInfoSelector({super.key, required this.controller, this.placeholder});
...
class _ItemDisplayInfoSelectorState extends State<ItemDisplayInfoSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = ItemDisplayInfoSelectorController();
...
class _Dialog extends StatefulWidget {
  final ItemDisplayInfoSelectorController controller;
            ...
            return FoxyShadTable(
              ...
              header: (context, column) {
                return switch (column) {
                  ...
                  1 => ShadTableCell.header(child: Text('模型名称')),
                  2 => ShadTableCell.header(child: Text('图标')),
