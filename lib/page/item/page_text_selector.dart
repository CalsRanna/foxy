...
import 'package:foxy/page/item/page_text_selector_controller.dart';
import 'package:foxy/widget/foxy_shad_table.dart';
import 'package:foxy/widget/pagination.dart';
import 'package:shadcn_ui/shadcn_ui.dart';

class PageTextSelector extends StatefulWidget {
  final TextEditingController controller;
  final String? placeholder;

  const PageTextSelector({super.key, required this.controller, this.placeholder});

  @override
  State<PageTextSelector> createState() => _PageTextSelectorState();
}

class _PageTextSelectorState extends State<PageTextSelector> {
  ...
  Future<void> _openDialog() async {
    final controller = PageTextSelectorController();
...
class _Dialog extends StatefulWidget {
  final PageTextSelectorController controller;
