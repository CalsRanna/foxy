...
@FoxyDetailViewModel(entity: ProspectingLootTemplateEntity, flags: {'lootMode'})
class ProspectingLootTemplateCollectionEditorViewModel
    with
        FieldControllerMixin, _ProspectingLootTemplateCollectionEditorViewModelMixin {
  final _repository = GetIt.instance.get<ProspectingLootTemplateRepository>();

  final parentKey = signal<int?>(null);
  final items = signal<List<BriefProspectingLootTemplateEntity>>([]);
