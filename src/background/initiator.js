  ...
  knex
    ...
    .then(() => {
      Promise.all([
        ...
        knex.raw(DBC.toSql(`${path}/AchievementCategory.dbc`)).then(() => { }),
        knex.raw(DBC.toSql(`${path}/AchievementCriteria.dbc`)).then(() => { }),
        ...
        knex.raw(DBC.toSql(`${path}/ScalingStatDistribution.dbc`)).then(() => { }),
        ...
        knex.raw(DBC.toSql(`${path}/SpellDescriptionVariables.dbc`)).then(() => { }),
