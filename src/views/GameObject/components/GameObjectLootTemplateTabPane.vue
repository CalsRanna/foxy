          ...
          <el-row :gutter="16">
            <el-col :span="6">
              <el-form-item label="编号">
                <el-input-number
                  v-model="gameObjectLootTemplate.Entry"
            ...
            <el-col :span="6">
              <el-form-item label="物品">
                <el-input-number
                  v-model="gameObjectLootTemplate.Item"
                  controls-position="right"
                  v-loading="initing"
                  placeholder="Item"
                  element-loading-spinner="el-icon-loading"
            ...
            <el-col :span="6">
              <el-form-item label="关联">
                <el-input-number
                  v-model="gameObjectLootTemplate.Reference"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="几率">
                <el-input-number
                  v-model="gameObjectLootTemplate.Chance"
                  controls-position="right"
                  placeholder="Chance"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="需要任务">
                <el-switch
                  v-model="gameObjectLootTemplate.QuestRequired"
                  :active-value="1"
                  :inactive-value="0"
                ></el-switch>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="掉落模式">
                <el-input-number
                  v-model="gameObjectLootTemplate.LootMode"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="组ID">
                <el-input-number
                  v-model="gameObjectLootTemplate.GroudId"
                  controls-position="right"
                  placeholder="GroudId"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="最小数量">
                <el-input-number
                  v-model="gameObjectLootTemplate.MinCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="最大数量">
                <el-input-number
                  v-model="gameObjectLootTemplate.MaxCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="注解">
                <el-input
                  v-model="gameObjectLootTemplate.Comment"
                  placeholder="Comment"
                ></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  computed: {
    ...
    ...mapState("gameObjectLootTemplate", [
  ...
  methods: {
    ...mapActions("gameObjectLootTemplate", [
      "searchGameObjectLootTemplates",
      "storeGameObjectLootTemplate",
      "findGameObjectLootTemplate",
      "updateGameObjectLootTemplate",
      "destroyGameObjectLootTemplate",
      "createGameObjectLootTemplate",
      "copyGameObjectLootTemplate",
    ]),
    async create() {
      this.creating = true;
      this.editing = false;
      await this.createGameObjectLootTemplate({
        Entry: this.gameObjectTemplate.entry,
      });
    },
    async store() {
      if (!this.editing) {
        await this.storeGameObjectLootTemplate(this.gameObjectLootTemplate);
        this.$notify({
          title: "保存成功",
        ...
        await this.updateGameObjectLootTemplate({
          credential: this.credential,
          gameObjectLootTemplate: this.gameObjectLootTemplate,
        });
        this.$notify({
          title: "修改成功",
          position: "bottom-left",
    ...
    async show(row) {
      this.creating = true;
      this.editing = true;
      await this.findGameObjectLootTemplate({
        Entry: row.Entry,
        Item: row.Item,
      });
    },
  ...
  components: { ItemTemplateName, ReferenceLootTemplateCards },
};
</script>
