        ...
        <el-tab-pane label="物体模版" name="game_object_template">
          ...
          >
            ...
            <el-card style="margin-top: 16px">
              <el-button
                type="primary"
                @click="() => store('game_object_template')"
                >保存</el-button
              >
        ...
        <el-tab-pane label="模版补充" name="game_object_template_addon">
          ...
          >
            ...
            <el-card style="margin-top: 16px">
              <el-button
                type="primary"
                @click="() => store('game_object_template_addon')"
                >保存</el-button
              >
              <el-button @click="cancel">返回</el-button>
            </el-card>
    ...
    >
      <div slot="title">
        <span style="font-size: 18px;color: #303133;margin-right:16px"
          >名称/使用文字本地化</span
        >
        <el-button size="mini" @click="addGameObjectTemplateLocale"
          >新增</el-button
        >
      </div>
      ...
      <div slot="footer">
        ...
        <el-button
          type="primary"
          @click="() => store('game_object_template_locales')"
          >保存</el-button
        >
      </div>
    </el-dialog>
    ...
    store(module) {
      switch (module) {
        ...
        case "game_object_template_locales":
          this.storeGameObjectTemplateLocales(
            this.gameObjectTemplateLocales
          ).then(() => {
            this.localeDialogVisible = false;
          });
          break;
        case "game_object_template_addon":
          if (this.gameObjectTemplateAddon.entry == undefined) {
            ...
            this.storeGameObjectTemplateAddon(
              this.gameObjectTemplateAddon
            ).then(() => {});
          } else {
            this.updateGameObjectTemplateAddon(
              this.gameObjectTemplateAddon
            ).then(() => {});
          }
          break;
