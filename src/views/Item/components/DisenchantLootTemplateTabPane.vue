          ...
          <el-row :gutter="16">
            <el-col :span="6">
              <el-form-item label="编号">
                <el-input-number
                  v-model="disenchantLootTemplate.Entry"
            ...
            <el-col :span="6">
              <el-form-item label="物品">
                <item-template-selector
                  v-model="disenchantLootTemplate.Item"
                  placeholder="Item"
                ></item-template-selector>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="关联">
                <el-input-number
                  v-model="disenchantLootTemplate.Reference"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="几率">
                <el-input-number
                  v-model="disenchantLootTemplate.Chance"
                  controls-position="right"
                  placeholder="Chance"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="需要任务">
                <el-switch
                  v-model="disenchantLootTemplate.QuestRequired"
                  :active-value="1"
                  :inactive-value="0"
                ></el-switch>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="掉落模式">
                <el-input-number
                  v-model="disenchantLootTemplate.LootMode"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="组ID">
                <el-input-number
                  v-model="disenchantLootTemplate.GroudId"
                  controls-position="right"
                  placeholder="GroudId"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="最小数量">
                <el-input-number
                  v-model="disenchantLootTemplate.MinCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="最大数量">
                <el-input-number
                  v-model="disenchantLootTemplate.MaxCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="注解">
                <el-input
                  v-model="disenchantLootTemplate.Comment"
                  placeholder="Comment"
                ></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  computed: {
    ...
    referenceEntries() {
      let entries = [];
      for (let disenchantLootTemplate of this.disenchantLootTemplates) {
        if (disenchantLootTemplate.Reference != 0) {
          entries.push(disenchantLootTemplate.Reference);
        }
      }
      return entries;
    },
  ...
  methods: {
    ...mapActions("disenchantLootTemplate", [
      "searchDisenchantLootTemplates",
      "storeDisenchantLootTemplate",
      "findDisenchantLootTemplate",
