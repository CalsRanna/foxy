          ...
          <el-row :gutter="16">
            <el-col :span="6">
              <el-form-item label="编号">
                <el-input-number
                  v-model="millingLootTemplate.Entry"
            ...
            <el-col :span="6">
              <el-form-item label="关联">
                <el-input-number
                  v-model="millingLootTemplate.Reference"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="几率">
                <el-input-number
                  v-model="millingLootTemplate.Chance"
                  controls-position="right"
                  placeholder="Chance"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="需要任务">
                <el-switch
                  v-model="millingLootTemplate.QuestRequired"
                  :active-value="1"
                  :inactive-value="0"
                ></el-switch>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="掉落模式">
                <el-input-number
                  v-model="millingLootTemplate.LootMode"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="组ID">
                <el-input-number
                  v-model="millingLootTemplate.GroudId"
                  controls-position="right"
                  placeholder="GroudId"
                ></el-input-number>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="最小数量">
                <el-input-number
                  v-model="millingLootTemplate.MinCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="最大数量">
                <el-input-number
                  v-model="millingLootTemplate.MaxCount"
                  controls-position="right"
            ...
            <el-col :span="6">
              <el-form-item label="注解">
                <el-input
                  v-model="millingLootTemplate.Comment"
                  placeholder="Comment"
                ></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  computed: {
    ...
    referenceEntries() {
      let entries = [];
      for (let millingLootTemplate of this.millingLootTemplates) {
        if (millingLootTemplate.Reference != 0) {
          entries.push(millingLootTemplate.Reference);
        }
      }
      return entries;
    },
  ...
  methods: {
    ...mapActions("millingLootTemplate", [
      "searchMillingLootTemplates",
      "storeMillingLootTemplate",
      "findMillingLootTemplate",
      "updateMillingLootTemplate",
      "destroyMillingLootTemplate",
      "createMillingLootTemplate",
      "copyMillingLootTemplate",
    ]),
    async create() {
      this.creating = true;
      this.editing = false;
      await this.createMillingLootTemplate({
        Entry: this.itemTemplate.entry,
      });
    },
    async store() {
      if (!this.editing) {
        await this.storeMillingLootTemplate(this.millingLootTemplate);
        this.$notify({
          title: "保存成功",
        ...
        await this.updateMillingLootTemplate({
          credential: this.credential,
          millingLootTemplate: this.millingLootTemplate,
        });
        this.$notify({
          title: "修改成功",
          position: "bottom-left",
      ...
      this.$confirm("此操作不会复制关联表数据，确认继续？", "确认复制", {
        ...
        beforeClose: (action, instance, done) => {
          if (action === "confirm") {
            ...
            this.copyMillingLootTemplate(this.credential)
              .then(() => {
                this.searchMillingLootTemplates({
                  Entry: this.itemTemplate.entry,
                });
              })
              .then(() => {
      ...
      this.$confirm(
        ...
        "确认删除",
        {
          ...
          beforeClose: (action, instance, done) => {
            if (action === "confirm") {
              instance.confirmButtonLoading = true;
              this.destroyMillingLootTemplate(this.credential)
                .then(() => {
                  this.searchMillingLootTemplates({
                    Entry: this.itemTemplate.entry,
                  });
    ...
    async show(row) {
      this.creating = true;
      this.editing = true;
      await this.findMillingLootTemplate({
        Entry: row.Entry,
        Item: row.Item,
      });
    },
