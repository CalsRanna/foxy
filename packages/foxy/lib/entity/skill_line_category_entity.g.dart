...
part of 'skill_line_category_entity.dart';

final class BriefSkillLineCategoryEntity {
  final int id;
  final String nameLangZhCN;

  const BriefSkillLineCategoryEntity({this.id = 0, this.nameLangZhCN = ''});

  factory BriefSkillLineCategoryEntity.fromJson(Map<String, dynamic> json) {
    return BriefSkillLineCategoryEntity(
      id: json['ID'] == true
          ? 1
          : json['ID'] == false
          ? 0
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is BriefSkillLineCategoryEntity &&
            id == other.id &&
...
mixin _SkillLineCategoryEntityMixin {
  @override
  int get hashCode {
    final self = this as SkillLineCategoryEntity;
  ...
  bool operator ==(Object other) {
    ...
    return identical(self, other) ||
        other is SkillLineCategoryEntity &&
  ...
  SkillLineCategoryEntity copyWith({
    int? id,
    String? nameLangEnUS,
    String? nameLangKoKR,
    String? nameLangFrFR,
    ...
    final self = this as SkillLineCategoryEntity;
    return SkillLineCategoryEntity(
      id: id ?? self.id,
  ...
  static SkillLineCategoryEntity fromJson(Map<String, dynamic> json) {
    return SkillLineCategoryEntity(
      id: json['ID'] == true
          ? 1
          : json['ID'] == false
      ...
      sortIndex: json['SortIndex'] == true
          ? 1
          : json['SortIndex'] == false
          ? 0
          : (json['SortIndex'] as num?)?.toInt() ?? 0,
    );
  }
}
