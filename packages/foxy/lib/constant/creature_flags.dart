...
abstract final class CreatureFlags {
  /// Unit-flag options
  static const unitFlagOptions = [
  ...
  static const spellSchoolImmuneMaskOptions = [
  ...
  static const mechanicImmuneMaskOptions = [
  ...
  static const lootModeFlagOptions = [
    FlagItem(0x0001, '默认'),
  ...
  static const inhabitTypeOptions = [
  ...
  /// Extra-flag options
  static const flagsExtraOptions = [
  ...
  static const dynamicFlagOptions = [
  ...
  /// Type-flag options
  static const creatureTypeFlagOptions = [
