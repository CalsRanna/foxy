...
abstract final class QuestFlags {
  static const questSpecialFlagsAllowedMask = 0x000001FF;

  /// Only the bits included in AzerothCore `QUEST_SPECIAL_FLAGS_DB_ALLOWED`.
  static const questSpecialFlagOptions = [
    FlagItem(0x0001, '可重复'),
  ...
  static const questFlagsAllowedMask = 0x000FFFFF;

  /// AzerothCore `QuestFlags` for the 3.3.5a client.
  static const questFlagOptions = [
