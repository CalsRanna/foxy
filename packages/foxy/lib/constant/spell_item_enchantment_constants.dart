...
abstract final class SpellItemEnchantmentConstants {
  /// `ItemModType` values handled by Player::ApplyEnchantment for type 5.
  static const spellItemEnchantmentStatOptions = <int, String>{
    0: '法力值',
    1: '生命值',
    3: '敏捷',
    4: '力量',
  ...
  static const spellItemEnchantmentSchoolOptions = <int, String>{
    0: '物理',
    1: '神圣',
    2: '火焰',
    3: '自然',
  ...
  static const spellItemEnchantmentFlagOptions = <FlagItem>[
  ...
  static const spellItemEnchantmentEffectTypeOptions = <int, String>{
    0: '无效果',
    1: '战斗触发法术',
    2: '武器伤害',
    3: '装备法术',
