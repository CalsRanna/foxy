...
abstract final class ConditionSourceTypes {
  static const conditionSourceTypesWithSourceId = <int>{22, 30};
  static const conditionSourceTypesWithGroup = <int>{
    1,
    2,
    3,
    4,
  ...
  static const conditionSourceTypeLabels = <int, String>{
  ...
  static int targetCount(int sourceTypeOrReferenceId) {
