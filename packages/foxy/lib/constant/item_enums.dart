...
abstract final class ItemEnums {
  /// StatType options
  static const itemStatTypeOptions = {
    0: '法力值', // Mana
    1: '生命值', // Health
    2: '保留（未定义）',
    3: '敏捷', // Agility
  ...
  static const itemSpellTriggerOptions = {
    0: '使用', // Use
    1: '装备', // Equip
  ...
  /// Sheath options
  static const itemSheathOptions = {
    0: '无', // None
  ...
  static const itemReputationRankOptions = {
    0: '仇恨',
    1: '敌对',
    2: '冷淡',
    3: '中立',
  ...
  /// Quality options
  static const itemQualityOptions = {
    0: '粗糙', // Poor
    1: '普通', // Common
    2: '优秀', // Uncommon
    3: '精良', // Rare
  ...
  /// Material options
  static const itemMaterialOptions = {
    -1: '消耗品', // Consumable
    0: '未定义', // None
    1: '金属', // Metal
    2: '木制品', // Wood
  ...
  /// FoodType options
  static const itemFoodTypeOptions = {
    0: '无', // None
    1: '肉', // Meat
    2: '鱼', // Fish
    3: '芝士', // Cheese
  ...
  static const itemBondingOptions = {
    0: '不绑定', // No Bind
