...
abstract final class AreaTableConstants {
  /// AzerothCore DBCEnums.h::AreaTeams used by AreaTableEntry::team.
  static const areaTeamOptions = {0: '无阵营', 2: '联盟', 4: '部落', 6: '双方'};

  static const areaTableMaxAreaBit = 4095;

  static const areaTableKnownFlagMask = 0x6FFFFFFF;

  /// AzerothCore DBCEnums.h::AreaFlags for the 3.3.5a AreaTable DBC.
  static const areaFlagOptions = [
