...
abstract final class ItemFlags {
  ...
  static const itemScalingStatValueOptions = [
  ...
  static const itemFlagsExtraOptions = [
    FlagItem(1, '部落'), // Horde
  ...
  static const itemFlagsCustomOptions = [
  ...
  static const itemBagFamilyOptions = [
  ...
  static const allowableRaceOptions = [
    FlagItem(1, '人类'), // Human
    FlagItem(2, '矮人'), // Dwarf
  ...
  static const allowableClassOptions = [
