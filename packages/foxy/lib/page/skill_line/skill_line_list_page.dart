...
@RoutePage()
class SkillLineListPage extends StatefulWidget {
  const SkillLineListPage({super.key});

  @override
  State<SkillLineListPage> createState() => _SkillLineListPageState();
}

class _SkillLineListPageState extends State<SkillLineListPage> {
  final viewModel = GetIt.instance.get<SkillLineListViewModel>();
  ...
  Widget _buildTable() {
    ...
    final table = FoxyDataTable<BriefSkillLineEntity>(
  ...
  void _navigateToDetail({int? key}) {
    GetIt.instance.get<RouterFacade>().navigateToDetail(
      route: SkillLineDetailRoute(skillLineKey: key),
      parentMenu: RouterMenu.skillLine,
    );
  }
}
