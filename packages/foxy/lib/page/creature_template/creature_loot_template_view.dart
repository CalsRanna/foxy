...
class _CreatureLootTemplateViewState extends State<CreatureLootTemplateView> {
  ...
  Widget _buildTable() {
    ...
    final table = FoxyDataTable<BriefCreatureLootTemplateEntity>(
      shrinkWrap: true,
      rows: items,
      columns: [
  ...
  Future<void> _destroy(CreatureLootTemplateKey key) async {
  ...
  Future<bool> _load(CreatureLootTemplateKey key) async {
    try {
