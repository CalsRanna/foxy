...
class QuestInfoListPage extends StatefulWidget {
  const QuestInfoListPage({super.key});

  @override
  State<QuestInfoListPage> createState() => _QuestInfoListPageState();
}

class _QuestInfoListPageState extends State<QuestInfoListPage> {
  final viewModel = GetIt.instance.get<QuestInfoListViewModel>();
  ...
  Widget _buildTable() {
    ...
    final table = FoxyDataTable<BriefQuestInfoEntity>(
      ...
      columns: [
        ...
        FoxyTableColumn.flex(
          label: '名称',
          cell: (_, item) => Text(item.infoNameLangZhCN),
        ),
      ],
