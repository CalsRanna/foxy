...
class GlyphPropertyListPage extends StatefulWidget {
  const GlyphPropertyListPage({super.key});

  @override
  State<GlyphPropertyListPage> createState() => _GlyphPropertyListPageState();
}

class _GlyphPropertyListPageState extends State<GlyphPropertyListPage> {
  ...
  Widget _buildTable() {
    ...
    final table = FoxyDataTable<BriefGlyphPropertyEntity>(
