...
part of 'creature_template_list_view_model.dart';

mixin _CreatureTemplateListViewModelMixin
  ...
  Future<void> destroy(int key) async {
    ...
    errorMessage.value = null;
    try {
      final record = await _repository.getCreatureTemplate(key);
  ...
  Future<void> _logActivity(
    ...
    int key, [
    CreatureTemplateEntity? record,
  ]) async {
    final resolved = record ?? await _repository.getCreatureTemplate(key);
