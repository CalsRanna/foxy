...
part of 'smart_script_list_view_model.dart';

mixin _SmartScriptListViewModelMixin
  ...
  Future<void> destroy(SmartScriptKey key) async {
    ...
    errorMessage.value = null;
    try {
      final record = await _repository.getSmartScript(key);
  ...
  Future<void> _logActivity(
    ...
    SmartScriptKey key, [
    SmartScriptEntity? record,
  ]) async {
    final resolved = record ?? await _repository.getSmartScript(key);
