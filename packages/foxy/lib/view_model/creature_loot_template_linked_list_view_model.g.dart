...
mixin _CreatureLootTemplateLinkedListViewModelMixin on FieldControllerMixin {
  ...
  Future<void> destroy(CreatureLootTemplateKey key) async {
    ...
    errorMessage.value = null;
    try {
      final record = await _repository.getCreatureLootTemplate(key);
  ...
  Future<void> _logActivity(
    ...
    CreatureLootTemplateEntity? record,
  ]) async {
    final resolved = record ?? await _repository.getCreatureLootTemplate(key);
