...
part of 'emote_text_list_view_model.dart';

mixin _EmoteTextListViewModelMixin on FieldControllerMixin, QueryVersionMixin {
  ...
  Future<void> destroy(int key) async {
    ...
    errorMessage.value = null;
    try {
      final record = await _repository.getEmoteText(key);
  ...
  Future<void> _logActivity(
    ...
    int key, [
    EmoteTextEntity? record,
  ]) async {
    final resolved = record ?? await _repository.getEmoteText(key);
