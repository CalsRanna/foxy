...
part of 'spell_item_enchantment_list_view_model.dart';

mixin _SpellItemEnchantmentListViewModelMixin
  ...
  Future<void> destroy(int key) async {
    ...
    errorMessage.value = null;
    try {
      final record = await _repository.getSpellItemEnchantment(key);
  ...
  SpellItemEnchantmentFilter _collectFilter() {
  ...
  Future<void> _logActivity(
    ...
    int key, [
    SpellItemEnchantmentEntity? record,
  ]) async {
    final resolved = record ?? await _repository.getSpellItemEnchantment(key);
    ...
    GetIt.instance.get<EventBus>().fire(
      EntityWrittenEvent(
        ActivityLogEntity(
          module: 'dbc_spell_item_enchantment',
          actionType: action,
