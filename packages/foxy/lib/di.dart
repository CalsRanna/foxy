...
import 'package:foxy/view_model/skill_line_list_view_model.dart';
...
class DI {
  ...
  static void _registerInteractionViewModels() {
    ...
    _instance.registerFactory(() => SkillLineListViewModel());
    _instance.registerFactory(() => SkillLineDetailViewModel());
    _instance.registerFactory(() => SkillLineAbilityLinkedListViewModel());
  ...
  static void _registerRepositories() {
    ...
    _instance.registerLazySingleton(() => SkillLineAbilityRepository());
    _instance.registerLazySingleton(() => SkillLineCategoryRepository());
    _instance.registerLazySingleton(() => SkillCostsDataRepository());
    _instance.registerLazySingleton(() => SkillTiersRepository());
    _instance.registerLazySingleton(() => SkillRaceClassInfoRepository());
