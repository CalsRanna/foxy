...
void main() {
  test('雕文类型使用 GlyphProperties/GlyphSlot 专属 0 和 1（0=大型, 1=小型）', () {
    ...
    expect(GlyphPropertyConstants.glyphPropertySlotTypeOptions, {
      0: '大型雕文',
      1: '小型雕文',
    });
    expect(
      GlyphPropertyConstants.glyphPropertySlotTypeOptions,
      isNot(contains(2)),
    );
  ...
  test('DBC definition 使用 3.3.5.12340 的 4 列物理格式', () {
    final definition = DbcDefinitions.byTable['dbc_glyph_properties']!;
